...
\begin{DoxyPre}
	include <\doxyref{mediastreamer2/mscommon.h}{p.}{mscommon_8h}>\end{DoxyPre}
...
\begin{DoxyPre}
	MSSndCard *sndcard;
	sndcard=ms\_snd\_card\_manager\_get\_default\_card(\doxyref{ms\_snd\_card\_manager\_get()}{p.}{group__mediastreamer2__soundcardmanager_gaa787408facfb672bab5afd8d86967602});\end{DoxyPre}
